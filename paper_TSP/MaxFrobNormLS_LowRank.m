function [FrobNormFinal, FrobNorm, Us] = MaxFrobNormLS_LowRank(Hd,F,G,Us,varargin)

% Description: This function optimizes a unitary and symmetric matrix 
...
% - It applies the LS (Line Search) version for gradient ascent
%
% Input parameters:
...
%
% Output parameters:
% FrobNormFinal: final value of Frob. norm
% FrobNorm: Frob. norm vs. iterations 
% Us: final unitary + symmetric BD-RIS
%
%
